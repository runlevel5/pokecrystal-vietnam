...
VioletCityName:      db "THÀNH PHỐ<BSP>KIKYO@"
AzaleaTownName:      db "THỊ TRẤN<BSP>HIWADA@"
GoldenrodCityName:   db "THÀNH PHỐ<BSP>KOGANE@"
EcruteakCityName:    db "THÀNH PHỐ<BSP>ENJU@"
OlivineCityName:     db "THÀNH PHỐ<BSP>ASAGI@"
CianwoodCityName:    db "THÀNH PHỐ<BSP>TANBA@"
MahoganyTownName:    db "THỊ TRẤN<BSP>CHOUJI@"
BlackthornCityName:  db "THÀNH PHỐ<BSP>FUSUBE@"
...
WhirlIslandsName:    db "QUẦN ĐẢO<BSP>ỐC XOÁY@"
...
ViridianCityName:    db "THÀNH PHỐ<BSP>TOKIWA@"
PewterCityName:      db "THÀNH PHỐ<BSP>NIBI@"
CeruleanCityName:    db "THÀNH PHỐ<BSP>HANADA@"
LavenderTownName:    db "THỊ TRẤN<BSP>SHION@"
VermilionCityName:   db "THÀNH PHỐ<BSP>KUCHIBA@"
