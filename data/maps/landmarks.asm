...
NewBarkTownName:     db "THÔN<BSP>NEW BARK@"
CherrygroveCityName: db "TP.<BSP>CHERRYGROVE@"
VioletCityName:      db "TP.<BSP>VIOLET@"
AzaleaTownName:      db "THÔN<BSP>AZALEA@"
...
MahoganyTownName:    db "THÔN<BSP>MAHOGANY@"
BlackthornCityName:  db "TP.<BSP>BLACKTHORN@"
LakeOfRageName:      db "HỒ<BSP>GYARADOS@"
SilverCaveName:      db "HANG<BSP>BẠC@"
SproutTowerName:     db "THÁP MẦM@"
...
LavRadioTowerName:   db "ĐÀI RADIO<BSP>LAVENDER@"
