...
NewBarkTownName:     db "THỊ TRẤN<BSP>NEW BARK@"
CherrygroveCityName: db "TP.<BSP>CHERRYGROVE@"
VioletCityName:      db "TP. VIOLET@"
AzaleaTownName:      db "THỊ TRẤN<BSP>AZALEA@"
...
MahoganyTownName:    db "THỊ TRẤN<BSP>MAHOGANY@"
BlackthornCityName:  db "TP.<BSP>BLACKTHORN@"
LakeOfRageName:      db "HỒ<BSP>GIẬN DỮ@"
