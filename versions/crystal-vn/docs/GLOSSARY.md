# Pokemon Crystal Vietnamese Localization - Glossary

This document contains all English-Vietnamese translation terms used in the Vietnamese localization of Pokemon Crystal.

## Table of Contents

- [Move Names](#move-names)
  - [Generation I Moves](#generation-i-moves-165-total)
  - [Generation II Moves](#generation-ii-moves-86-total)
...
| SLEEP | ngủ | Sleep (contextual) |

**Related Item Translations:**
...
- **ĐỐI THỦ** (Rival): Used for the player's rival
- **HLV** (Huấn Luyện Viên - Trainer): Used for generic trainers
...
**Note:** `<BSP>` is a line break macro used for map name popup display.
...
**Note:** Badge names are fully translated to Vietnamese (e.g., HUY HIỆU SẤM, HUY HIỆU ĐẦM LẦY). See Badge Names section below.
...
### Pokemon Names
All Pokemon species names remain in English (PIKACHU, RATTATA, etc.). Pokemon nicknames can be Vietnamese.

**Exception:** EGG (unhatched Pokemon placeholder) is translated to TRỨNG.

### Badge Names
Badge names are fully translated to Vietnamese:

| English | Vietnamese |
|---------|------------|
| ZEPHYRBADGE | HUY HIỆU GIÓ |
| HIVEBADGE | HUY HIỆU TỔ ONG |
| PLAINBADGE | HUY HIỆU ĐỒNG BẰNG |
| FOGBADGE | HUY HIỆU SƯƠNG MÙ |
| STORMBADGE | HUY HIỆU BÃO |
| MINERALBADGE | HUY HIỆU KHOÁNG |
| GLACIERBADGE | HUY HIỆU BĂNG |
| RISINGBADGE | HUY HIỆU THĂNG HOA |
| BOULDERBADGE | HUY HIỆU ĐÁ |
| CASCADEBADGE | HUY HIỆU THÁC |
| THUNDERBADGE | HUY HIỆU SẤM |
| RAINBOWBADGE | HUY HIỆU CẦU VỒNG |
| MARSHBADGE | HUY HIỆU ĐẦM LẦY |
| SOULBADGE | HUY HIỆU HỒN |
| VOLCANOBADGE | HUY HIỆU NÚI LỬA |
| EARTHBADGE | HUY HIỆU ĐẤT |

### Units
Pokemon height and weight are converted from imperial to metric:
- Height: feet/inches → meters (e.g., 5'07" → 1.7m)
- Weight: pounds → kilograms (e.g., 200 lbs → 91kg)
