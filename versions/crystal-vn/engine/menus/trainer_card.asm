...
CardStatusGFX: INCBIN "versions/crystal-vn/gfx/trainer_card/card_status.2bpp"

LeaderGFX:  INCBIN "versions/crystal-vn/gfx/trainer_card/leaders.2bpp"
LeaderGFX2: INCBIN "versions/crystal-vn/gfx/trainer_card/leaders.2bpp"
